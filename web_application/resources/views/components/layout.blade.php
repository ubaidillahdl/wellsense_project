...
<head>
    ...
    <title>{{ $title ?? 'PPG App' }}</title>
</head>

<body class="h-dvh w-dvw  sm:bg-linear-to-tr sm:from-slate-950 sm:to-slate-800 flex items-center justify-center sm:p-4">
    <div
        ...
        <div
            class="h-full w-full sm:rounded-[4.5vh] sm:pb-0  bg-slate-900  sm:border-[1.5vh] sm:border-gray-950 sm flex flex-col overflow-hidden">
